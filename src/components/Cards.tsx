...
const Cards = () => {
  return (
    <div className='h-[900px] max-sm:h-[1600px] relative w-full bg-black overflow-hidden'>
   ...
   className="flex items-center gap-4 justify-center w-[500px] overflow-hidden whitespace-nowrap">
    ...
    <div className=" text-[40px] max-sm:text-[20px] max-sm:w-[90vw] leading-tight text-white tracking-wider mt-8 w-[70vw]">
...
creating visuals that are as functional as they are beautiful, ensuring that they contribute to the overall success of the brand.</h1>
   ...
   <div className='absolute top-[45%] max-sm:top-[20%] w-[100%] max-sm:gap-2 grid grid-cols-3 max-sm:grid-cols-1 items-center'>
