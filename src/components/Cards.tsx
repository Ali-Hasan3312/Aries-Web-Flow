...
const Cards = () => {
  return (
   ...
   className="flex items-center gap-4 justify-center w-[500px] overflow-hidden whitespace-nowrap">
        ...
        <p className="text-white text-lg">AVAILABLE FOR WORK</p>
        <div className="h-2 w-2 rounded-full bg-orange-500">
        </div>
        <p className="text-white text-lg">AVAILABLE FOR WORK</p>
    </motion.div>
    <div className=" text-[40px] leading-tight text-white tracking-wider mt-8 w-[70vw]">
...
creating visuals that are as functional as they are beautiful, ensuring that they contribute to the overall success of the brand.</h1>
   ...
   <div className='absolute top-[45%] w-[60%] left-12 flex items-center gap-6'>
