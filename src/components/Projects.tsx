...
const Projects = () => {
  return (
    <div className='h-[2050px] max-sm:h-[1750px] relative w-full bg-gray-200'>
      <div className=' absolute top-[10%] max-sm:top-[2%] max-sm:left-[5%] left-[20%]'>
      <motion.div
   ...
   className="flex items-center gap-4 justify-center w-[500px] overflow-hidden whitespace-nowrap">
    ...
    <div className=" text-[40px] max-sm:w-[90vw] max-sm:text-[25px] leading-tight text-black tracking-wider mt-8 w-[70vw]">
   ...
   <div className=' absolute top-[30%] max-sm:top-[20%] left-[4%]'>
