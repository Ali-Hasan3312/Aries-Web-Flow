  ...
  return (
    <div className='h-[600px] relative w-full bg-black'>
      <WavyBackground className="max-w-4xl mx-auto pb-40">
        ...
        <div className='absolute top-20 left-[25%] w-[50%] flex flex-col gap-8'>
            <h1 className='text-white text-center text-[60px] uppercase font-bold leading-tight'>Ready to elevate your brand with aries?</h1>
